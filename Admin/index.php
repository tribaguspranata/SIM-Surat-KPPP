...
<body class="blue-grey lighten-3 bg">
    ...
    <!-- Container START -->
                 <div>
                   <a href="../index.php"><button class="btn btn info"> &#9754Back tO iNDEX</button></a>
                </div>
    <div class="container">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Sistem Informasi Manajemen Surat</h5>
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light blue-grey col s6" name="submit">LOGIN</button>
                            <button type="reset" class="btn-large waves-effect waves-light blue-grey col s6" name="cancel">RESET</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
